...
| Control integrity | Launch manifest and external controls | Pinned authority artifacts, externally controlled evidence/run record, and candidate hash are checked before and after evaluation. | Does not protect an attacker controlling the trust root. |
