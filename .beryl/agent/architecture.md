...
- BRPL v4 is an explicit prospective API and uses a host-neutral compiler/verifier over normalized evidence; language, manifest, Git, metric, and command extraction are external trusted adapters, while enforced v4 launch manifests pin and recheck the catalog, adapter bundle, checker, baseline, evaluator, policies, and candidate hash.
